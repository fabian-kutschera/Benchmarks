...
#mpiexec -n $SLURM_NTASKS /hppfs/work/pn49ha/ru64lev2/Benchmarking/SeisSol/build-release/SeisSol_Release_dskx_5_elastic parameters_tpv36.par
mpiexec -n $SLURM_NTASKS /hppfs/work/pn49ha/ru64lev2/Benchmarking/SeisSol/build-release/SeisSol_Release_dskx_4_elastic parameters_tpv36.par
