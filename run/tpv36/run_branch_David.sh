#!/bin/bash
#SBATCH -J tpv36
#SBATCH -o /hppfs/work/pn49ha/ru64lev2/Benchmarking/output/tpv36/%A_%x.out
...
mpiexec -n $SLURM_NTASKS /hppfs/work/pn49ha/ru64lev2/Benchmarking/v1.1.4/SeisSol/build-release/SeisSol_Release_dskx_4_elastic parameters_branch_David.par
...
#mpiexec -n $SLURM_NTASKS /hppfs/work/pn49ha/ru64lev2/Benchmarking/SeisSol/build-release/SeisSol_Release_dskx_4_elastic parameters.par
