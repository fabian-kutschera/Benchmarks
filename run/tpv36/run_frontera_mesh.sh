...
mpiexec -n $SLURM_NTASKS /hppfs/work/pn49ha/ru64lev2/Benchmarking/v1.2.0/SeisSol/build-release/SeisSol_Release_dskx_4_elastic parameters_frontera_mesh.par
