...
DefineConstant[ h_domain = {25e3, Min 0, Max 500e3, Name "Mesh spacing within model domain" } ];
DefineConstant[ h_fault = {250.0, Min 0, Max 30e3, Name "Mesh spacing on the fault" } ];
DefineConstant[ h_nucl = {100.0, Min 0, Max 3e3, Name "Refined mesh spacing within the fault nucleation patch" } ];
